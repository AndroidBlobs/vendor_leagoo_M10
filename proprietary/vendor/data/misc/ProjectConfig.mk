...
CUSTOM_HAL_IMGSENSOR = gc5025_mipi_raw sp5509_mipi_raw gc2385_mipi_raw sp250a_mipi_raw sp5508_mipi_raw
CUSTOM_HAL_LENS = dw9714af dummy_lens
CUSTOM_HAL_MAIN_04_IMGSENSOR = sp5508_mipi_raw
CUSTOM_HAL_MAIN_04_LENS = dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = sp5509_mipi_raw
...
CUSTOM_HAL_SUB_04_IMGSENSOR =
CUSTOM_HAL_SUB_04_LENS = dummy_lens
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = sp250a_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5025_mipi_raw sp5509_mipi_raw gc2385_mipi_raw sp250a_mipi_raw sp5508_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = no
# BIRD_FAKE_MAIN2_IMGSENSOR_SUPPORT = gc033a_mipi_raw
CUSTOM_KERNEL_MAIN_04_IMGSENSOR = sp5508_mipi_raw
CUSTOM_KERNEL_MAIN_04_LENS = dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = sp5509_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9714af
CUSTOM_KERNEL_SUB_04_IMGSENSOR =
CUSTOM_KERNEL_SUB_04_LENS = dummy_lens
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = sp250a_mipi_raw
...
CUSTOM_MODEM = Modem_7130TQ_P22_2G_4B_W_B1B8_FDD_B1B3B7B8B20_TDD40B41_V48_20181029
...
#device light sensor
BIRD_MMI_AUTO_TEST_LIGHT_SENSOR = yes
#device Gravity Sensor
BIRD_MMI_AUTO_TEST_SENSOR = yes
BIRD_MMI_AUTO_TEST_SENSOR_Z = yes
#device LED
...
BIRD_MMI_AUTO_TEST_KEYBOARDLED = yes
...
BIRD_MMI_AUTO_TEST_DIAL112 = yes
BIRD_MMI_AUTO_TEST_BATTERY_ID = yes
#STORAGE INFO
BIRD_MMI_STORAGE_INFO=yes
#去掉mmi test后副摄项
BIRD_MMI_BACKUPCAMERA=-1
#重力感应参数保留
BIRD_BACKUP_SENSOR = yes
#前闪光灯打开
...
#--------------------------|DRV Config Begin |------------------------
#----------|bird config Begin|-----------
BIRD_CUSTOM = 7130TQ_L5503L_DS883
BIRD_MCP_CUSTOM_MEMORYDEVICE = DSS08_MT6739_EVB
BIRD_SW_PLATFORM = BIRD_O1MP1_K39TV1_BSP
BIRD_PARA_INFO_CONFIG = 7130TQ_L5503L_DS883
#----------|bird config End	 |-----------
#----------|LCD Begin        |-----------
BIRD_LCD_DENSITY = 320
#----------|LCD End          |-----------
#----------|TP Begin         |-----------
#虚拟按键  
BIRD_HAS_NAVBAR = yes
...
#----------|camera Begin     |-----------
#-----|IMGSENSOR Begin  |------
BIRD_MAIN_IMGSENSOR = gc5025_mipi_raw_7130TQ_L5503L_DS168
BIRD_MAIN_LENS = dw9714af_7130TQ_L5503L_DS168
BIRD_MAIN_BACKUP_IMGSENSOR = sp5509_mipi_raw_7130TQF_F556_DS1616
BIRD_SUB_IMGSENSOR = gc2385_mipi_raw_7130TQ_L5503L_DS168
BIRD_SUB_BACKUP_IMGSENSOR = sp250a_mipi_raw_7130TQ_L5503L_DS168
BIRD_MAIN_04_IMGSENSOR = sp5508_mipi_raw_7130TQ_L5503L_DS168
BIRD_IMGSENSOR_LONGCAPTURETHRES_200MS = yes
BIRD_CAMERA_3A_L5503L = yes
BIRD_CAMERA_HDR_L5503L = yes
BIRD_FLASHLIGHT_L5503L = yes
#-----|IMGSENSOR End    |------
#----------|camera End       |-----------
#----------|fingerprint Begin|-----------
# BIRD_FINGERPRINT_OPENHAL_COMPATIBLE_SUPPORT = yes
# BIRD_SUPPORT_FP_CHIP = fingerprint_vendor microarary
# BIRD_SUPPORT_FP_SENSOR = fingerprint_sensor A118N
#----------|fingerprint End  |-----------
#----------|alsp Begin       |-----------
#----------|alsp End         |-----------
#----------|wifi Begin       |-----------
...
#--------------------------|GUI Config Begin |------------------------
#----------|NAME 	Begin      |-----------
BIRD_PRODUCT_MODEL=M10
BIRD_PRODUCT_NAME=M10
BIRD_PRODUCT_DEVICE=M10
BIRD_PRODUCT_MANUFACTURER=LEAGOO
BIRD_BUILD_PRODUCT=M10
BIRD_PRODUCT_BRAND=LEAGOO
BIRD_BT_STRING=LEAGOO__M10
BIRD_MTP_LABEL=LEAGOO__M10
# ro.bdmisc.mtp_model MTP???????????
BIRD_MTP_MODEL = LEAGOO__M10
BIRD_MTP_MANUFACTURER=LEAGOO
BIRD_PTP_MODEL=LEAGOO__M10
BIRD_WLAN_DIRECT_NAME=LEAGOO__M10
BIRD_WLAN_SSID_STRING=LEAGOO__M10
#----------|NAME 	End	       |-----------
#----------|Powen ON 	Begin	 |-----------
# 开机log配置 路径
...
BIRD_FIRST_LOGO = 7130TQ_L5503L_DS883_LOGO
BIRD_SECOND_LOGO = 7130TQ_L5503L_DS883_LOGO
...
BIRD_BOOT_ANIMATION = 7130TQ_L5503L_DS883_BOOT_ANI
BIRD_SHUTDOWN_ANIMATION = 
...
#----------|Ring 	End				 |-----------
#----------|WALLPAPER 	Begin|-----------
BIRD_DEFAULT_MEDIA_SOUND =12
#alps/bird/wallpaper/default_wallpaper
BIRD_DEFAULT_WALLPAPER = 7130TQ-L5503L-DS883-Default
#----------|WALLPAPER 	End  |-----------
#----------|Launcher Begin   |-----------
#----------|Launcher End     |-----------
#----------|THEME Begin			 |-----------
...
#----------|USB End					 |-----------
#----------|Lang Input  Begin|-----------
# 默认语言 目前支持ru_RU en_US zh_CN es_ES
BIRD_DEFAULT_LANGUAGES_PRODUCT_LOCALES = en_US
...
# BUG #29152 ???12???,?????????????
BIRD_KEYGUARD_DESKCLOCK_SHOW_AMPM = yes
#----------|Date Time End		 |-----------
#----------|Email Begin      |-----------
#----------|Email End        |-----------
#----------|Browser Begin    |-----------
...
#----------|GMS  Begin  |-----------
BUILD_GMS = yes
BIRD_CUSTOM_RELEASE_KEY = yes
BIRD_BUILD_VERSION_TAGS = release-keys
BIRD_SHOW_ANDROID_SECURITY_PATCH_MENU = yes
#----------|GMS  End    |-----------
#--------------------------|APK Add End  		|------------------------
#--------------------------|Must Open Begin |------------------------
#----------|Command  Begin   |-----------
...
BIRD_CUSTOM_RING_CFG = 7130TQ-L5503L

# 配置编码（如：287596263）
BIRD_CONFIG_CODE=287889522
# 兼容标识（如：A1）
...
#--------------------------|Other  End		|------------------------
#--------------------------|SW_VERSION Begin|------------------------
BIRD_BUILD_VERNO = LEAGOO_M10_OS3.0_E_2019.1.1
BIRD_CUSTOM_SW_VERSION = LEAGOO_M10_OS3.0_E_2019.1.1
BIRD_BUILD_NUMBER = LEAGOO_M10_OS3.0_E_2019.1.1
BIRD_EM_VERNO= LEAGOO_M10_OS3.0_E_2019.1.1
BIRD_INNER_SW_VERSION = 7130TQF_L5503L.A1.$(shell date +%Y%m%d).AD80.V10.HD-.DS883.B18.TST.EN
...
#----------|*****************|-----------
#--------------------------|*****************|------------------------
BIRD_TEE_MODE_SUPPORT = yes
#BUG #37096 [客户需求]添加快速拨号设置
BIRD_KEYBOARD_SPEEDDIAL = yes
BIRD_ADD_REGULATORY_INFO =yes
CY_SUPPORT_DOUBLE_RINGTOME=yes 
CY_RINGTONE_SIM_ONE=LEAGOO-Turkish.mp3
CY_RINGTONE_SIM_TWO=LEAGOO-Turkish.mp3
BIRD_PKG_SOUND_RECORDER = yes
BIRD_BATTERY_OPTION_DUP_HIDE = yes
#去掉工程模式
BIRD_FACTORY_POWERON_TEST=no
#BUG #37290  要求默认开启ZSD
BIRD_CAMERA_ZSD_ON=yes
BIRD_WRITE_IMEI=yes
#BUG #43407 
BIRD_CAMERA_LIGHT_MAX=yes
BIRD_MMI_TFLASH_FAKE=yes
ADUPS_FOTA_SUPPORT=yes
#拍照提示音
BIRD_SHUTTER_SOUND=on
BIRD_FAKE_FOCUS=yes
